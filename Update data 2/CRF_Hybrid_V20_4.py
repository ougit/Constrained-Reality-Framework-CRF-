...
class CRFHybridV20_4:
    ...
    def run(self, max_sweeps=400):
        print(f"CRF Hybrid V20.4  N={self.N}  lam_omega={self.lam_omega}")
        print(f"New: tier events | Psi probe | d_s oscillation analysis")
        print("-" * 72)
...
if __name__ == "__main__":
    sim = CRFHybridV20_4(N=500, dim=8, k=20)
